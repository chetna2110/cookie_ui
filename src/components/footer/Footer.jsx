      ...
      <div className="flex items-center justify-center  bg-gradient-to-r from-amber-200 to-white-400">
        <div>
          <img
            ...
            alt=""
            className="size-48  left-0 -top-[18px] ml-4"
          />
        </div>
        <div className="ml-9">
          <div className="text-2xl font-serif text-orange-950 leading-relaxed">
            ...
            <p>
              {" "}
              One <span className="font-bold">Component</span> at a Time
            </p>
          </div>
          <div className="inline-block">
            <Link
              to="https://github.com/chetna2110/cookie_ui"
              target="_blank"
              className="mt-4 flex items-center gap-3 bg-amber-600 text-white  px-2 py-2 rounded-lg font-semibold shadow-md transition-transform duration-300 hover:scale-110 hover:bg-amber-700"
            >
              <img
