        ...
        <ul className='flex space-x-6 p-5'>
          {navmenu.map((item)=>
          {
            return (<li key={item.id}>
              <a href={item.link} className="font-semibold hover:bg-amber-700 hover:text-white  hover:scale-110  px-3 py-2 rounded-lg transition-transform  duration-300">{item.title}</a>
            </li>
            );
          })}
        </ul>
